--Inserisco film
INSERT INTO movie (id, title, year, url_image) VALUES (nextval('movie_seq'), 'Inception', 2010, 'https://m.media-amazon.com/images/M/MV5BMjAxMzY3NjcxNF5BMl5BanBnXkFtZTcwNTI5OTM0Mw@@._V1_.jpg');
...
INSERT INTO movie (id, title, year, url_image) VALUES (nextval('movie_seq'), 'Pulp Fiction', 1994, 'https://m.media-amazon.com/images/M/MV5BZDRhZjgyMzMtNDRhNy00Yjg2LTlkZWMtODQ3NzJkZjVkNjUyXkEyXkFqcGc@._V1_FMjpg_UX1000_.jpg');
INSERT INTO movie (id, title, year, url_image) VALUES (nextval('movie_seq'), 'The Matrix', 1999, 'https://m.media-amazon.com/images/M/MV5BN2NmN2VhMTQtMDNiOS00NDlhLTliMjgtODE2ZTY0ODQyNDRhXkEyXkFqcGc@._V1_FMjpg_UX1000_.jpg');
INSERT INTO movie (id, title, year, url_image) VALUES (nextval('movie_seq'), 'Fight Club', 1999, 'https://m.media-amazon.com/images/M/MV5BOTgyOGQ1NDItNGU3Ny00MjU3LTg2YWEtNmEyYjBiMjI1Y2M5XkEyXkFqcGc@._V1_.jpg');
INSERT INTO movie (id, title, year, url_image) VALUES (nextval('movie_seq'), 'Forrest Gump', 1994, 'https://m.media-amazon.com/images/M/MV5BNDYwNzVjMTItZmU5YS00YjQ5LTljYjgtMjY2NDVmYWMyNWFmXkEyXkFqcGc@._V1_FMjpg_UX1000_.jpg');
...
INSERT INTO movie (id, title, year, url_image) VALUES (nextval('movie_seq'), 'The Godfather', 1972, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQBcv_UnO_LM_pwqSvqRLLwgkhJ-VMwmVNnn2oJpRu_4dm9_jNL0XH3smcXLXX-qja2M88&usqp=CAU');
